        ...
        <div className={Styles.ancestorContainer}>
            ...
            <div id='todoContainer' className={Styles.todoContainer}>
                {loading ? (
                    ...
                    todoData.map((entry) => (
                        <div key={entry._id} className={`${Styles.todo} ${editing === entry._id ? Styles.editing : ''}`}>
                            {editing === entry._id ? (
                                <>
                                    ...
                                    <div className={Styles.editField}>
                                        ...
                                        <input
                                            ...
                                            className={`${Styles.editInput} ${Styles.editDescription}`}
                                            onChange={(e) => setEditDescription(e.target.value)}
                                        />
                                    </div>
                                    <button className={Styles.saveButton} onClick={() => saveEditTodo(entry._id)}>
                                        Save
                                    </button>
                                </>
                            ) : (
                                <>
                                    <span className={Styles.infoContainer}>
                                        ...
                                        <div className={Styles.todoContent}>
                                            <span className={Styles.todoTitle}>{entry.title}</span>
                                            <span className={Styles.todoDescription}>{entry.description}</span>
                                        </div>
                                    </span>
                                    <span
